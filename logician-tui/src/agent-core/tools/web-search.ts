...
import { truncateTail, DEFAULT_MAX_BYTES } from "./truncate.ts";
...
export function createWebSearchTool(config: WebSearchConfig): Tool {
    ...
    return {
        ...
        parameters: {
            ...
            properties: {
                ...
                language: {
                    type: "string",
                    description:
                        "Language code (e.g. en, en-US, de). Default: auto.",
                },
                time_range: {
                    type: "string",
                    description:
                        "Time range: day, week, month, year. Default: none.",
                },
                max_results: {
                    type: "number",
        ...
        execute: async (
            ...
            const resultsLimit =
                Number(args.max_results) || maxResults;
