...
// Consolidated from types-messages.ts + types-tools.ts + types-events.ts + types-hooks.ts
// to reduce false cohesion boundaries. The barrel (types.ts) still re-exports
// everything so external import sites are unaffected.
...
// Re-export hook context types from types-hooks.ts for convenience.
export type {
	AgentHooks,
