...
import {
	...
	TsPluginManager,
} from "../extension/adapters/claude-code/plugin-manager.ts";
...
export type {
	...
	HookExecutionResult,
	LoadedHook,
} from "../extension/adapters/claude-code/plugin-executor.ts";
export {
	buildHookInput,
	executeCommand,
	executeLoadedHook,
...
// Manager exports
export { TsPluginManager } from "../extension/adapters/claude-code/plugin-manager.ts";
