...
// Ported from coding-agent's tools/truncate.ts. The temp-file spill still
// uses node:fs directly (createWriteStream) rather than ExecutionEnv —
// streaming writes aren't part of the FileSystem contract, and abstracting
// that is a bigger redesign than this port warrants for v1.
...
export class OutputAccumulator {
	...
	constructor(options: OutputAccumulatorOptions = {}) {
		...
		this.tempFilePrefix = options.tempFilePrefix ?? "agent-bash";
	}
