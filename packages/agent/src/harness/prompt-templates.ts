// ── Prompt templates ─────────────────────────────────────────────────────
// Loads .md prompt templates from disk and substitutes positional arguments
// ($1, $@, $ARGUMENTS, ${@:N}, ${@:N:L}) for explicit invocation. Ported from
// pi coding agent's harness/prompt-templates.ts.
 ...
 *
 * Source values are preserved exactly and attached to every loaded prompt template and diagnostic. This module does
