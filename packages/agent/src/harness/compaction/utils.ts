...
// File-operation tracking and LLM-message-to-plain-text serialization used by
// the compaction engine. Ported from pi coding agent's harness/compaction/utils.ts.
