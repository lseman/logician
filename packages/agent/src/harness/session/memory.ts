...
// SessionStorage/SessionRepo backed purely by SessionState (no persistence).
// Useful as a reference SessionStorage implementation, for tests, and as a
// working backend before the JSONL disk-backed one lands. Ported from pi
// coding agent's harness/session/memory.ts.
