 ...
 * pings on each new generation so the page reloads the log without
 * polling. Self-contained — no dependency on EohSession.
 */
...
import { extractEohSessionName } from "./jsonl.ts";
