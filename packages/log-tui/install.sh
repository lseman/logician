...
#   curl -fsSL https://raw.githubusercontent.com/lseman/logician/main/packages/log-tui/install.sh | bash -s -- 0.2.0
#   curl -fsSL https://raw.githubusercontent.com/lseman/logician/main/packages/log-tui/install.sh | bash -s -- --dry-run
#   curl -fsSL https://raw.githubusercontent.com/lseman/logician/main/packages/log-tui/install.sh | bash -s -- -v 0.2.0
