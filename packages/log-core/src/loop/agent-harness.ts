...
import { resolveEffectiveAcceptance } from "../guards/acceptance-contract.ts";
import { SoftToolRequirementManager } from "../guards/soft-tool-requirement.ts";
import { TextLoopDetector } from "../guards/text-loop-detector.ts";
...
import { taskObjectiveFromMessages } from "./adaptive-mode.ts";
import { emitMessagePair, withSystemPrompt } from "./callbacks.ts";
import type { AgentLoopConfig } from "./config.ts";
import { createProviderTurnState } from "./provider-turn.ts";
import {
	checkRunAbort,
	createToolRegistry,
