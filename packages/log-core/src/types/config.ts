...
import type { PermissionPolicy } from "../tools/permissions.ts";
import type { AcceptanceConfig } from "./acceptance.ts";
import type { AgentHooks, EventHandler, Tool } from "./messages.ts";
...
export interface AgentConfig {
	...
	onQuestionRequest?: (
		ctx: import("./messages.ts").AskUserContext,
	) => Promise<string>;
