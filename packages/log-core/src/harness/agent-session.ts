...
import { validateAgentConfig } from "../config/config-validator.ts";
import { ConfigurationStore } from "../config/configuration-store.ts";
import {
	resolveModelContextWindow,
	resolveModelMaxTokens,
} from "../config/models.ts";
import { AdaptiveContextController } from "../context/adaptive-context-controller.ts";
...
import type { AgentConfig, QueueMode } from "../types/config.ts";
import type {
	AgentEvent,
	AgentHooks,
...
export class AgentSession {
	...
	async compact(
		...
		return this.runInPhase("compaction", "compact", () =>
			this.compactor.compact("manual", /* force */ true, mode),
		);
	}
