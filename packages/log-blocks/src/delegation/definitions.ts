...
const GENERIC_SUBAGENT_PROMPT =
	...
	"conclusions). Do not pad it with process narration. A closing line like " +
	'"the task is complete" with no restated findings returns nothing useful. ' +
	"Restate the actual result in your final response.";
