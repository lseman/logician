...
import { defaultTaskManager } from "../shared/background-task-registry.ts";
import { minimizeBashOutput } from "../shared/minimize.ts";
import {
	getShellConfig,
	getShellEnv,
	killProcessTree,
...
import { defaultPersistentTerminalManager } from "../shared/terminal-pool.ts";
import {
	DEFAULT_MAX_BYTES,
	DEFAULT_MAX_LINES,
	formatSize,
