...
import { BackgroundTaskRegistry } from "../../shared/background-task-registry.ts";
import { getShellConfig } from "../../shared/shell.ts";
import { createManageTaskTool } from "../../tools/manage-task.ts";
