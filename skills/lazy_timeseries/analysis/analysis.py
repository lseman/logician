...
__skill__ = {
    "name": "Analysis",
    "description": "Use for diagnostics, anomaly inspection, descriptive analysis, and exploratory statistics on series.",
    "workflow": [
        "Start with descriptive and diagnostic checks before forecasting.",
        "Use anomaly and seasonality tools to narrow likely next steps.",
    ],
}
...
def _guess_season_length(y) -> int:
    import numpy as np
...
__tools__ = [compute_statistics, stationarity_tests, acf_pacf_peaks, compute_multivariate_stats, detect_trend, stl_seasonality, detect_anomalies, get_cached_anomalies, change_points]
