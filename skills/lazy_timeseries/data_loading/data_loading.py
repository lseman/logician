...
__skill__ = {
    "name": "Data Loading",
    "description": "Use for loading datasets, reading time-series files, and establishing the initial data frame.",
    "workflow": [
        "Establish the dataset and date/value columns first.",
        "Preserve original data so later preprocessing can be reverted.",
    ],
}
...
__tools__ = [set_numpy, load_csv_data, create_sample_data, get_data_info, restore_original]
