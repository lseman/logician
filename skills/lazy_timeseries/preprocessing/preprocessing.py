...
__skill__ = {
    "name": "Preprocessing",
    "description": "Use for cleaning, transforming, resampling, and preparing time-series data.",
    "workflow": [
        "Clean and regularize the series before higher-cost analysis or modeling.",
        "Use reversible transformations when practical so comparisons stay interpretable.",
    ],
}
...
__tools__ = [regularize_series, fill_missing, hampel_filter, detrend, transform_series, scale_series]
