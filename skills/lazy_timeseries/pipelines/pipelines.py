...
__skill__ = {
    "name": "Pipelines",
    "description": "Use for end-to-end time-series workflows that chain loading, preprocessing, modeling, and evaluation.",
    "workflow": [
        "Use only when the request truly spans multiple phases.",
        "Prefer focused tools when the user wants one specific step.",
    ],
}
...
__tools__ = [comprehensive_analysis]
