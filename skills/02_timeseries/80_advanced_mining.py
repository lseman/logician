...
@llm.tool(description="Discover Motifs (repeating patterns) and Discords (anomalies) using Matrix Profiles (SOTA).")
...
@llm.tool(description="Perform Granger Causality tests between multivariate time series.")
