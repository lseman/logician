...
@llm.tool(description="Fetch a URL and return its main text content (HTML stripped).")
...
@llm.tool(
    description="Search the web using DuckDuckGo (no API key required) and return top results."
)
...
@llm.tool(description="Look up a Python package on PyPI and return its metadata.")
...
@llm.tool(
    description="Read a raw file from a public GitHub repository without cloning it."
)
