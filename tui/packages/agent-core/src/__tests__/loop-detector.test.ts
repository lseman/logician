...
void test("detects stagnation (zero new result prefixes)", () => {
	...
	const turns = [
		{
			content: "reading",
			toolCalls: [tool("read_file", '{"path":"a"}', "Error: file not found")],
		},
		{
			content: "reading again",
			toolCalls: [tool("read_file", '{"path":"b"}', "Error: file not found")],
		},
		{
...
void test("does not flag when result prefixes vary", () => {
	...
	const turns = [
		...
		{
			content: "third",
			toolCalls: [tool("read_file", '{"path":"c"}', "content found here")],
		},
	];
	assert.equal(
		record(d, turns),
...
void test("getLoopDiagnostic returns message for degenerate", () => {
	...
	const turns = [
		{
			content: "read",
			toolCalls: [tool("read_file", '{"p":"a"}', "Error: not found")],
		},
		{
			content: "read again",
			toolCalls: [tool("read_file", '{"p":"b"}', "Error: not found")],
		},
		{
			content: "read again",
