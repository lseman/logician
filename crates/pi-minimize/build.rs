// Concatenates the per-command filter definitions (src/defs/*.toml) into a
// single builtin_filters.toml in OUT_DIR, embedded by the engine via
// include_str!. Ported from oh-my-pi's pi-shell build.rs.
