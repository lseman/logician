...
const NODES = {
  ...
  "tui-rendering":{ title:"Rendering", kicker:"tui/rendering", color:"#f472b6", type:"leaf",
  ...
  "tui-input":{ title:"Input", kicker:"tui/input", color:"#f472b6", type:"leaf",
  ...
  "tui-themes":{ title:"Themes", kicker:"tui/themes", color:"#f472b6", type:"leaf",
  ...
  "tui-overlays":{ title:"Overlays", kicker:"tui/overlays", color:"#f472b6", type:"leaf",
  ...
  s1:{ n:1, stype:"pipeline", title:"Message Queue", kicker:"agent-core/message-queue", color:"#38bdf8", type:"leaf",
  ...
  s2:{ n:2, stype:"pipeline", title:"Context Assembly", kicker:"agent-core/context", color:"#38bdf8", type:"leaf",
  ...
  s3:{ n:3, stype:"gate", title:"Compaction Check", kicker:"agent-core/compaction", color:"#fbbf24", type:"leaf",
  ...
  s4:{ n:4, stype:"pipeline", title:"Model Call", kicker:"agent-core/model-call", color:"#38bdf8", type:"leaf",
  ...
  s5:{ n:5, stype:"gate", title:"Parse Response", kicker:"agent-core/parse", color:"#fbbf24", type:"leaf",
  ...
  s6:{ n:6, stype:"pipeline", title:"Pre-Tool Hooks", kicker:"agent-core/hooks/pre", color:"#38bdf8", type:"leaf",
  ...
  s7:{ n:7, stype:"gate", title:"Permission Gate", kicker:"agent-core/permissions", color:"#fbbf24", type:"leaf",
  ...
  s9:{ n:9, stype:"pipeline", title:"Post-Tool Hooks", kicker:"agent-core/hooks/post", color:"#38bdf8", type:"leaf",
  ...
  s10:{ n:10, stype:"mem", title:"Append to Session", kicker:"agent-core/session", color:"#a78bfa", type:"leaf",
  ...
  "cap-todo":{ title:"todo", kicker:"agent-capabilities/todo", color:"#fbbf24", type:"leaf",
  ...
  "cap-ask-user":{ title:"ask-user", kicker:"agent-capabilities/ask-user", color:"#fbbf24", type:"leaf",
  ...
  "cap-subagents":{ title:"subagents", kicker:"agent-capabilities/subagents", color:"#fbbf24", type:"leaf",
  ...
  "cap-reasoners":{ title:"reasoners", kicker:"agent-capabilities/reasoners", color:"#fbbf24", type:"leaf",
  ...
  "cap-eoh":{ title:"eoh", kicker:"agent-capabilities/eoh", color:"#fbbf24", type:"leaf",
...
function stageColor(stype){
  return stype==="tool" ? "#34d399" : stype==="mem" ? "#a78bfa" : stype==="gate" ? "#fbbf24" : "#38bdf8";
}
